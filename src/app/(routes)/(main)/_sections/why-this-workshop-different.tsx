...
const rows: {
  label: string;
  cells: ({ icon: "check" | "x" } | { text: string })[];
}[] = [
  {
    label: "Built specifically for personal brands",
    cells: [{ icon: "check" }, { icon: "x" }, { text: "Partially" }],
  },
  {
    label: "Fair discovery, not buried in a general feed",
    cells: [{ icon: "check" }, { icon: "x" }, { icon: "x" }],
  },
  {
    label: "Indexed on Google & ready for AI search",
    cells: [{ icon: "check" }, { text: "Rarely" }, { text: "Rarely" }],
  },
  {
    label: "Free to use",
    cells: [{ icon: "check" }, { icon: "check" }, { text: "Rarely" }],
  },
  {
    label: "Connects founders and professionals directly",
    cells: [{ icon: "check" }, { icon: "x" }, { text: "Partially" }],
  },
];
