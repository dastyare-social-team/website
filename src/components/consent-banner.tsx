...
export function ConsentBanner({
  ...
  return (
    <div
      ...
      className="fixed bottom-28 left-1/2 z-50 w-[min(92vw,420px)] -translate-x-1/2 flex flex-col gap-y-2.5 rounded-3xl border border-primary/10 bg-white/50 backdrop-blur-3xl px-5 py-4 text-secondary/90"
    >
